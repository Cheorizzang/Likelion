...
("paullab CEO leegojun hello CEO").replace(/CEO/, "CTO")
("paullab CEO leegojun hello CEO").replace(/CEO/g, "CTO")

("paullab CEO leegojun hello CEO").match(/CEO/g)

("paullab CEO leegojun hello CEO").split(/CEO/g)

(/CEO/g).test("paullab CEO leegojun hello CEO")
...
/hello (?=world)/gm : hello 뒤에 world가 오는 것 (포지티브 매칭)

("hello hallo hello").match(/.(a|e|o)ll./gm)
("hello hallo hello").match(/.[eao]ll./gm)
