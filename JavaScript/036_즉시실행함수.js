...
// array와 같은 convention 자료형을 넘길 때에는 함수 안에서 값의 수정이 됨

// call by value (값의 전달) : 아규먼트에 값이 넘어올 때 복사한 값이 넘어온다!
// call by reference (참조/주소값의 전달) : 아규먼트에 값이 넘어올 때 주소값이 넘어온다! (주소값이 넘어왔으니 접근을 하면 원본이다!)
...
// 넘버값은 원시 타입이라서 변경이 안 되고 배열은 참조 타입이라서 변경된다고 이해해도 됨
